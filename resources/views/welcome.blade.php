        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="nav-principal">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a href="/comanda" class="btn btn-outline-light ml-4">Entrar</a>
              </li>
            </ul>
          </div>
    ...
    <section class="caixa"><!--/Início seção recursos -->
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <img src="img/responsivo.png" class="img-fluid" style="height: 220px;">
            <h4>Responsivo</h4>
            <p>
              Utilize o sistema em qualquer dispositivos que você quiser, celulares, tabletes, computadores, entre outros.
            </p>
          </div>
        </div>
      </div>
